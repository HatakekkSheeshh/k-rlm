...
/**
 * ResultPanel — panel hiển thị kết quả suy luận đã tổng hợp.
 *
 * Props:
 *   result {{ answer, time, tokens, hops, nodesUsed }} — dữ liệu kết quả
 */
const ResultPanel = ({ result }) => (
    <div className="p-6 rounded-2xl bg-slate-900 border border-emerald-900/50
                  shadow-xl shadow-emerald-900/10
                  animate-in slide-in-from-bottom-4 fade-in duration-500 flex-1">
